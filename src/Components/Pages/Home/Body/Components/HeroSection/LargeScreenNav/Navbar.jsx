...
function Navbar() {
  return (
    <>
      <div className="text-white flex items-center hidden justify-between md:hidden sm:hidden lg:flex px-20">
        <div>
          <svg
            width="100"
            height="50"
        ...
        <div className="text-base font-light flex items-center justify-center ml-40">
          <a href="#palces" className="px-3 capitalize hover:text-gray-300">
            Places To Stay
          </a>
          <a href="#experience" className="px-3 capitalize hover:text-gray-300">
            Experiences
          </a>
          <a href="#online" className="px-3 capitalize hover:text-gray-300">
            Online Experience
          </a>
        </div>
        <div className="flex items-center justify-between">
          <p className="capitalize px-4 text-sm">become a host</p>
          <GlobeIcon className="w-5 h-5" />
          <div className="bg-white text-black flex items-center justify-between rounded-full px-2 py-2 ml-4">
            <MenuIcon className="w-5 h-5 mx-2" />
            <UserIcon className="w-5 h-5 bg-gray-600 text-white w-8 h-8 rounded-full p-2" />
          </div>
        </div>
      </div>
      <div className="bg-white w-2/3 h-16 mx-auto mt-5 rounded-full py-4 px-6 hidden md:hidden sm:hidden lg:grid lg:grid-cols-4">
        <div className="flex items-start justify-center flex-col border-r">
          <p className="capitalize text-xs font-semibold">location</p>
          <p className="text-gray-400 font-light text-sm capitalize">
            where are you going?
          </p>
        </div>
        <div className="flex items-start justify-center flex-col border-r pl-5">
          <p className="capitalize text-xs font-semibold">check in</p>
          <p className="text-gray-400 font-light text-sm capitalize">
            add dates
          </p>
        </div>
        <div className="flex items-start justify-center flex-col border-r pl-5">
          <p className="capitalize text-xs font-semibold">checkout</p>
          <p className="text-gray-400 font-light text-sm capitalize">
            add dates
          </p>
        </div>
        <div className="flex items-center justify-between pl-5">
          <div className="flex items-start justify-center flex-col">
            <p className="capitalize text-xs font-semibold">guests</p>
            <p className="text-gray-400 font-light text-sm capitalize">
              add guests
            </p>
          </div>
          <SearchIcon className="w-4 h-4 bg-red-500 text-white p-2 w-10 h-10 rounded-full" />
        </div>
      </div>
    </>
  );
